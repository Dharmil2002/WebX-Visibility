...
@Component({
  ...
  templateUrl: './long-haul-lane-bulk-upload.component.html'
})
export class LongHaulLaneBulkUploadComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,
    ...
    private dialogRef: MatDialogRef<LongHaulLaneBulkUploadComponent>,
  ) {
  ...
  async fetchExistingData() {
    const request = {
      ...
      collectionName: "vendor_contract_lhl_rt",
      filter: {},
    };
