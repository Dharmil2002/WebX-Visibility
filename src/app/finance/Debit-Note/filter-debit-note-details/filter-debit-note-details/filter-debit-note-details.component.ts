...
import { customerFromApi, stateFromApi } from 'src/app/operation/pending-billing/filter-billing/filter-utlity';
import { StorageService } from 'src/app/core/service/storage.service';

@Component({
  selector: 'app-filter-debit-note-details',
  templateUrl: './filter-debit-note-details.component.html',
  // styleUrls: ['./filter-debit-note-details.component.sass']
})
export class FilterDebitNoteDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<FilterDebitNoteDetailsComponent>
  ) {
