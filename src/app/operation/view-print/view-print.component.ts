...
export class ViewPrintComponent implements OnInit {
  ...
  constructor(private Route: Router, private prqService:PrqService,private masterService: MasterService, @Inject(MAT_DIALOG_DATA) public item: any, public dialogRef: MatDialogRef<GenericTableComponent>) {
    if (item) {
