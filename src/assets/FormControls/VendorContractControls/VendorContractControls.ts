    ...
    this.VendorContractControlArray = [
      {
        ...
        value: "",
        validation: "",
        callfunction: "VendorTypeChange",
        filterOptions: "",
        autocomplete: "",
        displaywith: "",
        errormessage: "Please select proper option",
        errormessageforpattern: "",
    ...
    this.ServiceMatrixTypeControlArray = [
      {
        name: "MatrixTypes",
        label: "MatrixTypes",
        placeholder: "MatrixTypes",
        type: "Staticdropdown",
        value: [
          {
            name: "Trip Lane Based : Farthest Distance (From City - To City)",
            value: "2",
          },
          {
            name: "Trip Lane Based : Farthest Distance (Location - Area)",
            value: "1",
          },
          { name: "Trip Distance Based : Farthest Distance", value: "3" },
        ],
        Validations: [],
        generatecontrol: true,
        disable: false,
    ...
    this.MatrixTypeControlArray = [
      {
        ...
        type: "Staticdropdown",
        value: [
          { name: "From City - To City", value: "C" },
          { name: "Location - Pincode", value: "L" },
        ],
        Validations: [],
        generatecontrol: true,
        disable: false,
