...
export class HolidayControl {
    ...
    constructor(HolidayData) {
        this.holidayControlArray = [
            {
                name: 'dateType', label: "Date Type", placeholder: "Date Type", type: 'Staticdropdown',
                value: [{ name: 'By Date', value: 'DATE' }, { name: 'By Day', value: 'DAY' }], filterOptions: "", autocomplete: "", displaywith: "", generatecontrol: true, disable: false,
                Validations: [],
                additionalData: {
        ...
        this.dateWiseControls=[
            {
                name: 'holidayDate', label: 'Holiday Date', placeholder: 'Holiday Date', type: 'date', value: HolidayData.holidayDate, generatecontrol: true, disable: false, Validations: [],
                additionalData: {
