        ...
        this.vehicleDetailsControl =
            [
                ...
                },
                {
                    ...
                    value: vehicleTable.vehicleType, filterOptions: "", autocomplete: "", displaywith: "", generatecontrol: true, disable: false,
                    Validations: [
                        {
                            name: "required",
                ...
                },
                {
                    ...
                    value: vehicleTable.controllBranch, filterOptions: "", autocomplete: "", displaywith: "", generatecontrol: true, disable: false,
                    Validations: [
                        {
                            name: "required",
                ...
                },
                {
                    ...
                    value: vehicleTable.assetName, filterOptions: "", autocomplete: "", displaywith: "", generatecontrol: true, disable: false,
                    Validations: [
                        {
                            name: "required",
                ...
                },
                {
                    ...
                    value: vehicleTable.vendorType, filterOptions: "", autocomplete: "", displaywith: "", generatecontrol: true, disable: false,
                    Validations: [
                        {
                            name: "required",
                            message: "Vendor Type is required.."
                ...
                {
                    name: 'route', label: "Routes", placeholder: "", type: 'dropdown',
                    value: '', filterOptions: "", autocomplete: "", displaywith: "", generatecontrol: true, disable: false,
                    Validations: [],
                    functions: {
                        //onToggleAll: 'toggleLocationSelectAll'
                    },
                    additionalData: {
                ...
                {
                    name: 'Drivers', label: 'No. Of Drivers', placeholder: 'Enter No. Of Drivers', type: 'number', value: 0, generatecontrol: true, disable: false,
                    Validations: [
                        {
                            name: "pattern",
                ...
                {
                    name: 'gpsProvider', label: 'GPS Provider', placeholder: 'Search and select GPS Provider', type: 'dropdown', value: vehicleTable.gpsProvider, generatecontrol: true, disable: false,
                    Validations: [
                    // {
                    //     name: "required",
                ...
                },
                {
                    ...
                    type: 'dropdown', value: vehicleTable.permitState, filterOptions: "", autocomplete: "", displaywith: "",
                    Validations: [
                        {
                            name: "autocomplete",
                        },
                ...
                {
                    name: 'ftlType', label: "FTL Type", placeholder: "Search and select FTL Type", type: 'dropdown',
                    value: vehicleTable.ftlType, filterOptions: "", autocomplete: "", displaywith: "", generatecontrol: true, disable: false,
                    Validations: [
                        {
                            name: "required",
                ...
                {
                    name: 'VEHMADEBY', label: 'VEHMADEBY', placeholder: '', type: 'text', value: '', generatecontrol: false, disable: false,
                    Validations: []
                },
                {
